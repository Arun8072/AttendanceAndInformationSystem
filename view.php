...
<div class="tab-content">
    ...
    if (isset($_GET["dept"])) {
        ...
        $time = date("H:i");
        if (
            $time >= date("H:i", strtotime("09:00")) &&
            $time < date("H:i", strtotime("10:00"))
        ) {
            $pr = "p1";
        } elseif (
            $time >= date("H:i", strtotime("10:00")) &&
            ...
            $time >= date("H:i", strtotime("12:00")) &&
            $time < date("H:i", strtotime("12:50"))
        ) {
            $pr = "p4";
        } elseif (
            $time >= date("H:i", strtotime("13:30")) &&
            $time < date("H:i", strtotime("14:15"))
        ) {
            $pr = "p5";
        } elseif (
            $time >= date("H:i", strtotime("14:15")) &&
            $time < date("H:i", strtotime("15:00"))
        ) {
            $pr = "p6";
        } elseif (
            $time >= date("H:i", strtotime("15:15")) &&
            $time < date("H:i", strtotime("16:00"))
        ) {
            $pr = "p7";
        } elseif (
            $time >= date("H:i", strtotime("16:00")) &&
            $time < date("H:i", strtotime("22:35"))
        ) {
            $pr = "p8";
        } else {
            //$pr = "Timeout";
...
<?php
 ...
 //              AND table_name = '{$tname1a}'
 //        ) 
 //        THEN (
 //            SELECT COUNT(Name) 
 //            FROM {$tname1a} 
 //            WHERE RegisterNumber != '1'
 //        )
 //        ELSE 0
 //    END AS b1";
$result = $conn->query($sql);
...
<th>$y</th>";
    ...
    if ($result === false) {
        //echo "<span style='display:none'><br>Select-Error : " .$conn->error."</span>";
    } elseif ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo "<td>" . fu($row["$y"]) . "</td>";
        }
...
if (date("m") >= $semesterDuration) {
    ...
    //for final semester
    $currentYear = date("Y") - 1;
} //UG // clg year=current year - final year
$fi = $currentYear . ($currentYear + $ug_duration);
$tw = $currentYear - 1 . ($currentYear - 1 + $ug_duration);
$th = $currentYear - 2 . ($currentYear - 2 + $ug_duration);
$fo = $currentYear - 3 . ($currentYear - 3 + $ug_duration); //PG
$mfi = $currentYear . ($currentYear + $pg_duration);
$mtw = $currentYear - 1 . ($currentYear - 1 + $pg_duration);
?>
...
<div class="collapsible-body">     
 ...
 <!--GET value to php to change dept-->
     <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fi .
         "CSEA"; ?>">CSE-A</button></li>
 <li>   <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fi .
     "CSEB"; ?>">CSE-B</button></li>
 </ul>
</div>
 </li><!--acc child-->
...
<div class="collapsible-body">     
 <ul>
   <li> <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $tw .
       "CSEA"; ?>">CSE-A</button></li>
   <li>  <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $tw .
       "CSEB"; ?>">CSE-B</button></li>
 </ul>
...
<div class="collapsible-body">     
 <ul>
 <li> <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $th .
     "CSEA"; ?>">CSE-A</button></li>
   <li><button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $th .
       "CSEB"; ?>">CSE-B</button></li>
 </ul>
...
<div class="collapsible-body">     
 <ul>
     <li> <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fo .
         "CSEA"; ?>">CSE-A</button></li>
   <li><button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fo .
       "CSEB"; ?>">CSE-B</button></li>
 </ul>
...
<div class="collapsible-body">     
 <ul>
     <li>  <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fi .
         "ECEA"; ?>">ECE-A</button></li>
   <li>   <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fi .
       "ECEB"; ?>">ECE-B</button></li>
 </ul>
</div>
 </li><!--acc child-->
...
<div class="collapsible-body">     
 <ul>
     <li>  <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fi .
         "EEEA"; ?>">EEE-A</button></li>
  <li>  <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fi .
      "EEEB"; ?>">EEE-B</button></li>
 </ul>
</div>
 </li><!--acc child-->
...
<div class="collapsible-body">     
 <ul>
     <li> <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fi .
         "MECHA"; ?>">MECH-A</button></li>
   <li><button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fi .
       "MECHB"; ?>">MECH-B</button></li>
 </ul>
</div>
 </li><!--acc child-->
...
<div class="collapsible-body">     
 <ul>
   <li> <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fi .
       "CIVILA"; ?>">CIVIL-A</button></li>
   <li> <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $fi .
       "CIVILB"; ?>">CIVIL-B</button></li>
 </ul>
</div>
 </li><!--acc child-->
...
<div class="collapsible-body">     
 <ul>
   <li> <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $mfi .
       "MBAA"; ?>">MBA-A</button></li>
   <li><button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $mfi .
       "MBAB"; ?>">MBA-B</button></li>
 </ul>
</div>
 </li><!--acc child-->
...
<div class="collapsible-body">     
 <ul>
   <li> <button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $mtw .
       "MBAA"; ?>">MBA-A</button></li>
   <li><button name="dept" class="form-control-plaintext" type="submit"  value="<?php echo $mtw .
       "MBAB"; ?>">MBA-B</button></li>
 </ul>
...
var elem = document.querySelectorAll('.sidenav');
 var insn = M.Sidenav.getInstance(elem);
insn.open();
