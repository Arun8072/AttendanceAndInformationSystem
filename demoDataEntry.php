...
for ($loopvar1=0; $loopvar1 < count($allYear); $loopvar1++) { 
    for ($loopvar2=0; $loopvar2 < count($depart); $loopvar2++) { 
        for ($loopvar3=0; $loopvar3 < count($section); $loopvar3++) { 
           ...
           // $sqlt = "INSERT INTO {$tname} (RegisterNumber,Name)VALUES ('$reg','$Name') ";
            // prepare and bind
            $stmt = $conn->prepare("INSERT INTO {$tname} (RegisterNumber,Name) VALUES (?, ?)");
 ...
 $sqlt->bind_param("ssssssssssssssssssssssssssssssssssssssssssssssssss", $us, $ps, $sp1, $sp2, $sp3, $sp4, $sp5, $sp6, $sp7, $sp8, $fp1, $fp2, $fp3, $fp4, $fp5, $fp6, $fp7, $fp8, $tp1, $tp2, $tp3, $tp4, $tp5, $tp6, $tp7, $tp8,$wp1, $wp2, $wp3, $wp4, $wp5, $wp6, $wp7, $wp8, $tup1, $tup2, $tup3, $tup4, $tup5, $tup6, $tup7, $tup8, $mp1, $mp2, $mp3, $mp4, $mp5, $mp6, $mp7, $mp8);
            if ($sqlt->execute()) {
